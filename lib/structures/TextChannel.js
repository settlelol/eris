...
class TextChannel extends GuildChannel {
    ...
    */
    ...
    loading() {
        return this.client.createMessage.call(this.client, this.id, { embed: { description: '<a:ro_loading:745386574690255051> This might take a couple of seconds.' } })
    }
