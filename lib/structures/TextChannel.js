...
class TextChannel extends GuildChannel {
    ...
    */
    ...
    sendError(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '16711680', description: '<:no:763502927792177182> ' + content } });
    }
    ...
    sendSuccess(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '3117824', description: '<:yes:763502950952730644> ' + content } })
    }
