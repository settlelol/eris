...
class TextChannel extends GuildChannel {
    ...
    */
    ...
    sendError(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '16711680', description: '<:no:762884741069275156> ' + content } });
    }
    ...
    sendSuccess(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '3117824', description: '<:yes:762884751832252417> ' + content } })
    }
